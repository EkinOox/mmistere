...
const Amphi3 = () => {
    ...
    useEffect(() => {
        document.body.classList.remove('body-background-amphi-objet');
    ...
    const finalText = [
        <p className="l1">Regarde au dos il y a un numéro de box de production derrière !</p>,
        <p className="l2">Essaye de chercher des indices là-bas, moi je te laisse là, on se voit plus tard !</p>,
