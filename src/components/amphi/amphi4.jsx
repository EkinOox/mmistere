...
const Amphi4 = () => {
    ...
    const finalText = [
        <p className="l1">Regarde au dos il y a un sticker de la salle réseau !</p>,
        <p className="l2">Essaye de chercher des indices là-bas, moi je te laisse là, à plus !</p>,
        <p className="l3">Prends aussi les deux autres, tu retrouveras peut-être leur propriétaire.</p>,
    ];
