...
const Salle2 = () => {
    ...
    const initialText = [
        ...
        <p key="l2" className="l2">Pendant que tu es là, aide moi s’il te plaît. Je n’arrive pas à trouver le vraie flyer parmi les deux, tu peux m’aider ?</p>,
    ];

    useEffect(() => {
        document.body.classList.add('body-background-salle2');
        const audio = new Audio(backgroundAudio);
        audio.loop = true;
        audio.play();
        return () => {
            document.body.classList.remove('body-background-salle2');
            document.body.classList.remove('body-background-salle2-jeux');
            audio.pause();
            audio.currentTime = 0;
        };
    }, []);
    ...
    useEffect(() => {
        ...
        const showNewImgTimeout = setTimeout(() => {
            document.body.classList.add('body-background-salle2-eva-tips');
    ...
    const handleButtonClick = () => {
        document.body.classList.remove('body-background-salle2');
        document.body.classList.remove('body-background-salle2-eva-tips');
        document.body.classList.add('body-background-salle2-jeux');
