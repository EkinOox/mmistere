...
const Salle3 = () => {
    ...
    const initialText = [
        <p key="l1" className="l1">Qu’est-ce que tu viens faire là ? Oh mon ordinateur, merci ! </p>,
        <p key="l2" className="l2">Pendant que tu es là, aide moi s’il te plaît. Je n’arrive pas à trouver le vrai code parmi les deux, tu peux m’aider ?</p>,
    ];
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            document.body.classList.remove('body-background-salle3-jeux');
            audio.pause();
            audio.currentTime = 0;
        };
    }, []);
    ...
    useEffect(() => {
        ...
        const showNewImgTimeout = setTimeout(() => {
            document.body.classList.add('body-background-salle3-kyllian-tips');
    ...
    const handleButtonClick = () => {
        document.body.classList.remove('body-background-salle3-kyllian-tips');
        document.body.classList.add('body-background-salle3-jeux');
