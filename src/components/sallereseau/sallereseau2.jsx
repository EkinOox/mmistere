...
const Sallereseau2 = () => {
    ...
    useEffect(() => {
        document.body.classList.add('body-background-sallereseau-azzura');
        const audio = new Audio(backgroundAudio);
        audio.loop = true;
        audio.play();
        return () => {
            document.body.classList.remove('body-background-sallereseau-azzura');
            audio.pause();
            audio.currentTime = 0;
        };
    }, []);
